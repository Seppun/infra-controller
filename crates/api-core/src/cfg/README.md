...
with the site overlap gate enabled. Generated, non-stretched Tenant linknets
inherit that ID from their exact parent. Direct segments remain global even
when a VpcPrefix adopts them.
...
the indexes. Access resumes when the migration commits.
