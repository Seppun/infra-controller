...
| `ssh_console_url` | `Option<Url>` | — | `machines` | URL to the ssh-console service. Used for live streaming of BMC logs via the `StreamConsoleLogs` gRPC, and the admin-ui's Console Logs page for each machine. |
